...
namespace StartMenuProtector.View
{
    ...
    {
        private TaskbarIcon TrayIcon = new TaskbarIcon { ToolTipText = "Start Menu Protector", IconSource = new BitmapImage(Util.Util.GetResourceURI(Config.TrayIconFilePath))};
